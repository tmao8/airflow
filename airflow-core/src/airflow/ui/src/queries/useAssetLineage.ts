...
export const useAssetLineage = (assetId: string | undefined) => useQuery<AssetLineageGraphResponse>({
                ...
                setTimeout(() => {
                    ...
                    resolve({
                        edges: [
                            ...
                            { source_id: "downstream_dag.consumer_task", target_id: "target_asset_2" },
                        ],
                        nodes: [
                            ...
                            { group: "tasks", id: "downstream_dag.consumer_task", name: "consumer_task", node_type: "task" },
                            { group: "assets", id: "target_asset_2", name: "target_asset_2", node_type: "asset" },
                        ],
                    });
